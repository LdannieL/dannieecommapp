...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Dannie's eCommerce</title>
    ...
    <body>
        ...
        <div id="wrapper">
            <header>
                <section id="top-area">
                    <p>Phone orders: 1-800-0000 | Email us: <a href="mailto:d.annie01a@yahoo.com">office@shop.com</a></p>
                </section><!-- end top-area -->
                <section id="action-bar">
                    <div id="logo">
                        <a href="/">Dannie's<span id="logo-accent"> e</span>Commerce</a>
                    </div><!-- end logo -->
            ...
            <footer>
                <section id="contact">
                    <h3>For phone orders please call 1-800-000. You<br>can also email us at <a href="mailto:d.annie01a@yahoo.com">office@shop.com</a></h3>
                </section><!-- end contact -->
                ...
                <section class="clearfix">
                    <div id="copyright">
                        ...
                        <p id="store-copy">&copy; {{ date ('Y')}} Dannie's eCommerce.</p>
                    </div><!-- end copyright -->
                    <div id="connect">
